...
describe('ComicList', () => {
  ...
  it('shows a list of comics', () => {
    ...
    expect(screen.getAllByTestId('comics__list--item')).toHaveLength(mockComicData.data.results.length)
  });
  ...
  it('shows a text if the comic does not have a cover', () => {
    ...
    expect(screen.getByTestId('comics__image--not-found')).toHaveTextContent('Cover not found');
  });
