...
describe('CharacterList', () => {
  ...
  it('shows an error message when the request returns an error', () => {
    ...
    expect(screen.getByTestId('error__message')).toHaveTextContent('Oops! Something went wrong');
  });
  ...
  it('shows a loading message when the request is pending', () => {
    ...
    expect(screen.getByTestId('loading__message')).toHaveTextContent('Loading...');
  });
  ...
  it('shows elements provided by data', () => {
    ...
    expect(screen.getAllByTestId('character__list--item')).toHaveLength(data.length);
    expect(screen.getAllByTestId('card__name')[0]).toHaveTextContent('Character1');
    expect(screen.getAllByTestId('card__name')[1]).toHaveTextContent('Character2');
  });
