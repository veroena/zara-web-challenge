...
describe('CharacterDetail', () => {
  ...
  it('shows an image of the character that coincides with the url params', () => {
    ...
    expect(screen.getByTestId('detail__img').src).not.toContain('storm-image.jpg');
  });

  it('shows a description of the character that coincides with the url params', () => {
    render(wrappedCharacterDetail('storm'));

    expect(screen.getByTestId('detail__description')).toHaveTextContent('mutant part of the X-Men');
    expect(screen.getByTestId('detail__description')).not.toHaveTextContent('Norse god');
  });
  ...
  it('shows an empty heart icon if the character is not in the favorites list', () => {
    ...
    expect(screen.queryByTestId('favorites__icon--fill')).not.toBeInTheDocument();
  });
  ...
  it('shows a filled heart icon if the character is not in the favorites list', () => {
    ...
    expect(screen.queryByTestId('favorites__icon--empty')).not.toBeInTheDocument();
  });
